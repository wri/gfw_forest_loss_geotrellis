...
case class GrossEmissionsNonCo2Co2eBiomassSoil(gridTile: GridTile, model: String = "standard", kwargs: Map[String, Any])
  ...
  //  val uri: String =
  //    s"s3://gfw-data-lake/gfw_forest_flux_full_extent_gross_emissions_non_co2_biomass_soil/v20231114/raster/epsg-4326/{grid_size}/{row_count}/Mg_CO2e_ha-1/geotiff/{tile_id}.tif"
}
