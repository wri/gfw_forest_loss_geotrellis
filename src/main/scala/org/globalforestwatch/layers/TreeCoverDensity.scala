...
case class TreeCoverDensityThreshold2000(gridTile: GridTile)
  ...
  val uri: String = s"$basePath/umd_tree_cover_density_2000/v1.8/raster/epsg-4326/${gridTile.gridSize}/${gridTile.rowCount}/percent/gdal-geotiff/${gridTile.tileId}.tif"
}

case class TreeCoverDensityThreshold2010(gridTile: GridTile)
  extends TreeCoverDensityThreshold {
  val uri: String = s"$basePath/umd_tree_cover_density_2010/v1.8/raster/epsg-4326/${gridTile.gridSize}/${gridTile.rowCount}/percent/gdal-geotiff/${gridTile.tileId}.tif"
}
