...
object TreeLossDF {
  ...
  def unpackValues(df: DataFrame): DataFrame = {
    ...
    val cols = List(
      ...
      $"data.primaryForestTreeCoverExtent" as "primary_forest_tree_cover_extent__ha",
      $"data.iflTreeCoverExtent" as "intact_forest_landscapes_2016_tree_cover_extent__ha",
      $"data.peatlandsTreeCoverExtent" as "peatlands_tree_cover_extent__ha",
      $"data.wdpaTreeCoverExtent" as "protected_areas_tree_cover_extent__ha",
