...
case class TreeLossTile(
  ...
  extends CellGrid[Int] {
    ...
    lazy val gpwCultivatedGrasslandExtent2020 = sources.gpwCultivatedGrasslandExtent2020.fetchWindow(windowKey, windowLayout)
    lazy val gpwCultivatedGrasslandExtent2021 = sources.gpwCultivatedGrasslandExtent2021.fetchWindow(windowKey, windowLayout)
    lazy val gpwCultivatedGrasslandExtent2022 = sources.gpwCultivatedGrasslandExtent2022.fetchWindow(windowKey, windowLayout)
    lazy val gpwCultivatedGrasslandExtent2023 = sources.gpwCultivatedGrasslandExtent2023.fetchWindow(windowKey, windowLayout)
    lazy val gpwCultivatedGrasslandExtent2024 = sources.gpwCultivatedGrasslandExtent2024.fetchWindow(windowKey, windowLayout)
