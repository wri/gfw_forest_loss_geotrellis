...
case class ForestChangeDiagnosticTile(
  ...
  prodesAmazonLossYear: ProdesAmazonLossYear#OptionalITile,
  prodesCerradoLossYear: ProdesCerradoLossYear#OptionalITile,
  ...
  detailedWdpaProtectedAreas: DetailedProtectedAreas#OptionalITile,
