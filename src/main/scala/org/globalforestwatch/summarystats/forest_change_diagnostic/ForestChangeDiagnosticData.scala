...
case class ForestChangeDiagnosticData(
  ...
  tree_cover_loss_country_specific_yearly: ForestChangeDiagnosticDataLossApproxYearlyCategory,
  tree_cover_loss_country_specific_wdpa_yearly: ForestChangeDiagnosticDataLossApproxYearlyCategory,
