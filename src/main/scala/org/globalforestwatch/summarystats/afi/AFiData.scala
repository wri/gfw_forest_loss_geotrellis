...
case class AFiData(
                    ...
                    var natural_forest_loss_by_year__ha: AFiDataLossYearly,
                    var jrc_forest_loss_by_year__ha: AFiDataLossYearly,
                  ) {
...
object AFiData {
  def empty: AFiData =
    AFiData(0, 0, 0, 0, 0, 0, AFiDataLossYearly.empty, AFiDataLossYearly.empty)
