  ...
  def sumArea(df: DataFrame): DataFrame = {
    ...
    df.groupBy($"iso", $"adm1", $"treecover_density__threshold")
      .agg(
        ...
        sum($"2001_co2_emissions__Mg") as "co2_emissions_2001__Mg",
        sum($"2002_co2_emissions__Mg") as "co2_emissions_2002__Mg",
        sum($"2003_co2_emissions__Mg") as "co2_emissions_2003__Mg",
        sum($"2004_co2_emissions__Mg") as "co2_emissions_2004__Mg",
        sum($"2005_co2_emissions__Mg") as "co2_emissions_2005__Mg",
        sum($"2006_co2_emissions__Mg") as "co2_emissions_2006__Mg",
        sum($"2007_co2_emissions__Mg") as "co2_emissions_2007__Mg",
        sum($"2008_co2_emissions__Mg") as "co2_emissions_2008__Mg",
        sum($"2009_co2_emissions__Mg") as "co2_emissions_2009__Mg",
        sum($"2010_co2_emissions__Mg") as "co2_emissions_2010__Mg",
        sum($"2011_co2_emissions__Mg") as "co2_emissions_2011__Mg",
        sum($"2012_co2_emissions__Mg") as "co2_emissions_2012__Mg",
        sum($"2013_co2_emissions__Mg") as "co2_emissions_2013__Mg",
        sum($"2014_co2_emissions__Mg") as "co2_emissions_2014__Mg",
        sum($"2015_co2_emissions__Mg") as "co2_emissions_2015__Mg",
        sum($"2016_co2_emissions__Mg") as "co2_emissions_2016__Mg",
        sum($"2017_co2_emissions__Mg") as "co2_emissions_2017__Mg",
        sum($"2018_co2_emissions__Mg") as "co2_emissions_2018__Mg"
      )
  }
