...
object CarbonFluxDF {
  ...
  def unpackValues(df: DataFrame): DataFrame = {
    ...
    df.select(
      ...
      $"dataGroup.threshold" as "umd_tree_cover_density_2000__threshold",
      $"dataGroup.isLoss" as "is__umd_tree_cover_loss",
      $"dataGroup.isGain" as "is__umd_tree_cover_gain",
      $"dataGroup.mangroveBiomassExtent" as "is__gmw_mangroves_extent",
      $"dataGroup.drivers" as "tsc_tree_cover_loss_drivers__driver",
      $"dataGroup.ecozones" as "wwf_eco_region__name",
      $"dataGroup.landmark" as "is__landmark_indigenous_and_community_lands",
      $"dataGroup.wdpa" as "wdpa_protected_areas__iucn_cat",
      $"dataGroup.intactForestLandscapes" as "ifl_intact_forest_landscapes__year",
      ...
      $"dataGroup.primaryForest" as "is__umd_regional_primary_forest_2001",
      ...
      $"dataGroup.isBurnLoss" as "is__gfw_burn_loss_2001-2021",
