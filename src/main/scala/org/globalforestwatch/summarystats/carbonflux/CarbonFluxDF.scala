...
object CarbonFluxDF {
  ...
  val contextualLayers: List[String] = List(
    ...
    "is__prodes_legal_amazon_umd_tree_cover_loss_2001-2020",
  ...
  def unpackValues(df: DataFrame): DataFrame = {
    ...
    df.select(
      ...
      $"dataGroup.landmark" as "is__landmark_land_rights",
      ...
      $"dataGroup.isLossLegalAmazon" as "is__prodes_legal_amazon_umd_tree_cover_loss_2001-2020",
  ...
  def whitelist(groupByCols: List[String])(df: DataFrame): DataFrame = {
    ...
    df.groupBy(groupByCols.head, groupByCols.tail: _*)
      .agg(
        ...
        max($"is__prodes_legal_amazon_umd_tree_cover_loss_2001-2020") as "is__prodes_legal_amazon_umd_tree_cover_loss_2001-2020",
