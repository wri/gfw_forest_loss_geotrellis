  ...
  def sumArea(df: DataFrame): DataFrame = {
    ...
    df.groupBy(
      ...
      .agg(
        ...
        sum("treecover_loss__ha") as "treecover_loss_2001-2015_ha",
        ...
        sum("gross_emissions_co2e_all_gasses__Mg") as "gross_emissions_co2e_all_gasses_2001-2015__Mg"
      )
  }
}
