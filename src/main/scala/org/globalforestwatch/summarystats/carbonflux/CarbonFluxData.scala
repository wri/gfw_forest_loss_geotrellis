...
case class CarbonFluxData(var totalTreecoverLoss: Double,
                          ...
                          var totalGrossEmissionsCo2eCo2OnlySoilOnly: Double,
                          var totalGrossEmissionsCo2eCh4SoilOnly: Double,
                          var totalGrossEmissionsCo2eN2oSoilOnly: Double,
                          var totalGrossEmissionsCo2eNonCo2SoilOnly: Double,
                          var totalGrossEmissionsCo2eSoilOnly: Double,
  ...
  def merge(other: CarbonFluxData): CarbonFluxData = {
    CarbonFluxData(
      ...
      //TODO: Update soil_only to biomass_only when ready.
      totalGrossEmissionsCo2eCo2OnlySoilOnly + other.totalGrossEmissionsCo2eCo2OnlySoilOnly,
      totalGrossEmissionsCo2eCh4SoilOnly + other.totalGrossEmissionsCo2eCh4SoilOnly,
      totalGrossEmissionsCo2eN2oSoilOnly + other.totalGrossEmissionsCo2eN2oSoilOnly,
      totalGrossEmissionsCo2eNonCo2SoilOnly + other.totalGrossEmissionsCo2eNonCo2SoilOnly,
      totalGrossEmissionsCo2eSoilOnly + other.totalGrossEmissionsCo2eSoilOnly,
