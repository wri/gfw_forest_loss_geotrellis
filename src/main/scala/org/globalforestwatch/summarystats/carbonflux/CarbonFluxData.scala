...
case class CarbonFluxData(var totalTreecoverLoss: Double,
                          ...
                          var totalGrossEmissionsCo2eCo2OnlyBiomassOnly: Double,
                          var totalGrossEmissionsCo2eCh4BiomassOnly: Double,
                          var totalGrossEmissionsCo2eN2oBiomassOnly: Double,
                          var totalGrossEmissionsCo2eNonCo2BiomassOnly: Double,
                          var totalGrossEmissionsCo2eBiomassOnly: Double,
                          ...
                          var totalTreecoverExtent2010_30: Double,
  ...
  def merge(other: CarbonFluxData): CarbonFluxData = {
    CarbonFluxData(
      ...
      totalGrossEmissionsCo2eCo2OnlyBiomassOnly + other.totalGrossEmissionsCo2eCo2OnlyBiomassOnly,
      totalGrossEmissionsCo2eCh4BiomassOnly + other.totalGrossEmissionsCo2eCh4BiomassOnly,
      totalGrossEmissionsCo2eN2oBiomassOnly + other.totalGrossEmissionsCo2eN2oBiomassOnly,
      totalGrossEmissionsCo2eNonCo2BiomassOnly + other.totalGrossEmissionsCo2eNonCo2BiomassOnly,
      totalGrossEmissionsCo2eBiomassOnly + other.totalGrossEmissionsCo2eBiomassOnly,
      ...
      totalTreecoverExtent2010_30 + other.totalTreecoverExtent2010_30,
