...
case class CarbonFluxGridSources(gridTile: GridTile, kwargs: Map[String, Any])
  ...
  val grossAnnualAbovegroundRemovalsCarbon: GrossAnnualAbovegroundRemovalsCarbon = GrossAnnualAbovegroundRemovalsCarbon(gridTile, kwargs = kwargs)
  val grossAnnualBelowgroundRemovalsCarbon: GrossAnnualBelowgroundRemovalsCarbon = GrossAnnualBelowgroundRemovalsCarbon(gridTile, kwargs = kwargs)
  ...
  val grossEmissionsCo2eNonCo2BiomassSoil: GrossEmissionsNonCo2Co2e = GrossEmissionsNonCo2Co2e(gridTile, kwargs = kwargs)
  val grossEmissionsCo2eCo2OnlyBiomassSoil: GrossEmissionsCo2OnlyCo2e = GrossEmissionsCo2OnlyCo2e(gridTile, kwargs = kwargs)
  val grossEmissionsCo2eNonCo2SoilOnly: GrossEmissionsNonCo2Co2eSoilOnly = GrossEmissionsNonCo2Co2eSoilOnly(gridTile, kwargs = kwargs)
  val grossEmissionsCo2eCo2OnlySoilOnly: GrossEmissionsCo2OnlyCo2eSoilOnly = GrossEmissionsCo2OnlyCo2eSoilOnly(gridTile, kwargs = kwargs)
  ...
  def readWindow(
    ...
    for {
      ...
      val grossEmissionsCo2eNonCo2BiomassSoilTile = grossEmissionsCo2eNonCo2BiomassSoil.fetchWindow(windowKey, windowLayout)
      val grossEmissionsCo2eCo2OnlyBiomassSoilTile = grossEmissionsCo2eCo2OnlyBiomassSoil.fetchWindow(windowKey, windowLayout)
      val grossEmissionsCo2eNonCo2SoilOnlyTile = grossEmissionsCo2eNonCo2SoilOnly.fetchWindow(windowKey, windowLayout)
