...
object CarbonSensitivityDF {
  ...
  val contextualLayers: List[String] = List(
    ...
    "is__legal_amazon_umd_tree_cover_loss_2001-2015",
    "is__legal_amazon_prodes_extent_2000",
    "is__mekong_umd_tree_cover_loss_first_year_2001-2015",
    "is__mekong_umd_tree_cover_loss_extent",
  ...
  def unpackValues(df: DataFrame): DataFrame = {
    ...
    df.select(
      ...
      $"dataGroup.prodesLegalAmazonExtent2000" as "is__legal_amazon_prodes_extent_2000",
      $"dataGroup.isLoss20012015Mekong" as "is__mekong_umd_tree_cover_loss_first_year_2001-2015",
      $"dataGroup.mekongTreeCoverLossExtent" as "is__mekong_umd_tree_cover_loss_extent",
      ...
      $"data.totalGrossEmissionsCo2eNoneCo2" as "gfw_gross_emissions_co2e_non_co2__Mg",
      ...
      $"data.totalTreeCoverLossFirstYear20012015Mekong" as "mekong_umd_tree_cover_loss_first_year__ha"
    )
  }
  def aggSummary(groupByCols: List[String])(df: DataFrame): DataFrame = {
    ...
    df.groupBy(groupByCols.head, groupByCols.tail ::: contextualLayers: _*)
      .agg(
        ...
        sum("umd_tree_cover_loss__ha") as "umd_tree_cover_loss_2001-2015__ha",
        sum("whrc_aboveground_biomass_loss__Mg") as "whrc_aboveground_biomass_loss_2001-2015__Mg",
        ...
        sum("mekong_umd_tree_cover_loss_first_year__ha") as "mekong_umd_tree_cover_loss_first_year_2001-2015__ha"
      )
  }
  ...
  def aggSummary2(groupByCols: List[String])(df: DataFrame): DataFrame = {
    ...
    df.groupBy(groupByCols.head, groupByCols.tail ::: contextualLayers: _*)
      .agg(
        ...
        sum("gfw_soil_carbon_stock_2000__Mg") as "gfw_soil_carbon_stock_2000__Mg",
        //        sum("gfw_total_carbon_stock_2000__Mg") as "gfw_total_carbon_stock_2000__Mg",
        sum("umd_tree_cover_loss_2001-2015__ha") as "umd_tree_cover_loss_2001-2015__ha",
        sum("whrc_aboveground_biomass_loss_2001-2015__Mg") as "whrc_aboveground_biomass_loss_2001-2015__Mg",
        ...
        sum("mekong_umd_tree_cover_loss_first_year_2001-2015__ha") as "mekong_umd_tree_cover_loss_first_year_2001-2015__ha"
      )
  }
  ...
  def aggChange(groupByCols: List[String])(df: DataFrame): DataFrame = {
    ...
    df.groupBy(
      ...
      .agg(
        ...
        sum("mekong_umd_tree_cover_loss_first_year__ha") as "mekong_umd_tree_cover_loss_first_year__ha"
      )
  }
  ...
  def whitelist(groupByCols: List[String])(df: DataFrame): DataFrame = {
    ...
    df.groupBy(groupByCols.head, groupByCols.tail: _*)
      .agg(
        ...
        max($"is__mekong_umd_tree_cover_loss_first_year_2001-2015") as "is__mekong_umd_tree_cover_loss_first_year_2001-2015",
        max($"is__mekong_umd_tree_cover_loss_extent") as "is__mekong_umd_tree_cover_loss_extent",
